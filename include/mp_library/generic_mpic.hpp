...
#ifndef GENERIC_MPIC_H
#define GENERIC_MPIC_H
...
namespace lrt_mpic
{
  ...
  /**
     * This class is the generically usable MP
  */
  class GenericMPIC : public ManipulationPrimitive
  {
  public:
    /* Constructors */
    GenericMPIC();
    GenericMPIC(const std::string folder_path, const std::string mp_file_name);
